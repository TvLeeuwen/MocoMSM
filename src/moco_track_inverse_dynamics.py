...
Optimizes non-kinematics states for close correspondes to predicted kinematics
    by Timo van Leeuwen
Based on:
...
Input model and kinematics generated by:
    Emu model build and published by Pacha van Bijleveld - doi:
    Prediction model by Pacha van Bijleveld
